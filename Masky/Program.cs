    ...
    public class Program
    {
        ...
        public static void Main(string[] unparsed_args)
        {
            try
            {
                ...
                bool output_console = args.output_console;
                ...
                // If console output, write on console. Else, create output&debug files. 
                if (output_console)
                    Console.WriteLine(JsonConvert.SerializeObject(cert.spoofedUsers, Formatting.Indented));
                else
                {
